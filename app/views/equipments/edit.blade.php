...
@section('content')
    <div class="page-header">
        <h1>Edit Equipment <small>Go on, mark it complete!</small></h1>
    </div>

    <form action="{{ action('EquipmentController@handleEdit') }}" method="post" role="form">
        ...
        <a href="{{ action('EquipmentController@index') }}" class="btn btn-link">Cancel</a>
    </form>
@stop
